...
**Install packages**
```
docker exec laravel_bookreview composer install
```

**Generate app key**
```
docker exec laravel_bookreview php artisan key:generate
```
...
**Rollback Migrations**
```
docker exec laravel_bookreview php artisan migrate:rollback
```

**Run seed scripts**
```
docker exec laravel_bookreview php artisan db:seed
```

**Refresh migrations and seeds**
```
docker exec laravel_bookreview php artisan migrate:refresh --seed
```
